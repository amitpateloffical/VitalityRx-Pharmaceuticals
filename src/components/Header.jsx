        ...
        <div className="px-5">
          <nav className="navbar navbar-expand-lg navbar-dark p-0 py-5">
            <Link to="/" className="navbar-brand a-index">
              <img className="" style={{ height: "120px", width: "100px", paddingTop: "20px", background:"none"}} src="vitailogo1.png" alt="Life Link Digital" />
            </Link>
            <Link to="/" >
              <div style={{ color: "#004526" }} className="logo123">VITAI'YRX Pharmaceuticals</div>
            </Link>
            <button
              type="button"
